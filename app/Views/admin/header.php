    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if(in_array($activeMenu,['chart'])){ echo "menu-open";}?>">
            <a href="#" class="nav-link <?php if(in_array($activeMenu,['chart'])){ echo "active";}?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('chart') ?>" class="nav-link <?php if($activeMenu == 'chart') echo "active"; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ChartJS</p>
                </a>
              </li>
